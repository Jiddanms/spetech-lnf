...
('Gedung B', 'Area kelas dan laboratorium gedung B', 'lokasi=Gedung+B'),
('Gedung C', 'Area gedung C dan ruang seni', 'lokasi=Gedung+C'),
...
('Kantin', 'Area kantin sekolah', 'lokasi=Kantin');
...
('found', 'Kunci Motor Honda', 'Ditemukan di dekat parkiran', 'Gedung A', 'Budi Penemu', 'verified'),
('lost', 'Dompet Hitam', 'Isi kartu pelajar atas nama Andi', 'Kantin', 'Andi Pemilik', 'pending');
